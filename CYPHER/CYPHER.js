...
function draw(){
 ...
 textSize(fontSize);
 //fill(214, 79, 0);
 fill(255,0,153 + sin(frameCount*40) * 168);
 //fill(255);
 text(testText, width/2, height/2);
  ...
  //spin = map(mouseX, 0,width, 0,360);//mousex goes from 0 point to the width of the screen which makes the text rotate from 0 to 360
  //rotate(spin);
  //fill(x, 0, 255);
  //textSize(mouseY/1.5);
  //textAlign(CENTER, CENTER);
...
function sampler(){
  ...
  //textAlign(CENTER);
  //fill(214, 79, 0);
 // testText ('ABCDEFGHIJKLM', width/2, height/2+5);
  //testText ('NOPQRSTUVXYZ', width/2, height/2+80);
 // testText ('0123456789', width/2, height/2+155);
  //testText ('?!#:;,.', width/2, height/2+230);
